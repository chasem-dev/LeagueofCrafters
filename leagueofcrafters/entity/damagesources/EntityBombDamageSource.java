...
public class EntityBombDamageSource extends EntityDamageSourceIndirect {
	private String player;
	private ChatMessageComponent message = new ChatMessageComponent();

	public EntityBombDamageSource(String par1Str, Entity par2Entity, Entity par3Entity) {
	...
	public ChatMessageComponent getDeathMessage(EntityLivingBase par1EntityLivingBase) {
		...
		message.addText(player + " was killed by Ziggs");
		return message;
	}
}
