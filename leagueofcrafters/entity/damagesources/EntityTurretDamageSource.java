...
public class EntityTurretDamageSource extends EntityDamageSourceIndirect {
	private String player;
	private ChatMessageComponent message = new ChatMessageComponent();

	public EntityTurretDamageSource(String par1Str, Entity par2Entity, Entity par3Entity) {
	...
	public ChatMessageComponent getDeathMessage(EntityLivingBase par1EntityLivingBase) {
		...
		message.addText(player + " was executed");
		return message;
	}
}
