...
public class EntityPukeball extends EntityThrowable {
	public EntityPukeball(World par1World) {
		super(par1World);
	}

	public EntityPukeball(World par1World, EntityLivingBase par2EntityLivingBase) {
		super(par1World, par2EntityLivingBase);
	}

	public EntityPukeball(World par1World, double par2, double par4, double par6) {
		...
		if (par1MovingObjectPosition.entityHit != null)
			if (par1MovingObjectPosition.entityHit instanceof EntityLivingBase) {
				...
				if (par1MovingObjectPosition.entityHit != this.getThrower()) {
		            player.attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), 3);
