...
import leagueofcrafters.entity.damagesources.EntityDartDamageSource;
...
public class EntityDart extends EntityThrowable implements IProjectile {
	...
	/** 1 if the player can pick up the dart */
	public int canBePickedUp;

	/** Seems to be some sort of timer for animating an dart. */
	...
	/** The amount of knockback an dart applies when it hits a mob. */
	...
	public EntityDart(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
	...
	/**
	 * Similar to setdartHeading, it's point the throwable entity to a x, y, z
	 * direction.
	 */
			...
			if (movingobjectposition != null) {
				if (movingobjectposition.entityHit != null) {
					...
					if (this.shootingEntity == null) {
						damagesource = this.causeDartDamage(this, this);
					} else {
						damagesource = this.causeDartDamage(this, this.shootingEntity);
					}
	...
	public static DamageSource causeDartDamage(EntityDart par0EntityDart, Entity par1Entity) {
		return (new EntityDartDamageSource("Dart", par0EntityDart, par1Entity)).setProjectile();
	}
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
		...
		par1NBTTagCompound.setByte("shake", (byte) this.dartShake);
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
		...
		this.dartShake = par1NBTTagCompound.getByte("shake") & 255;
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
		if (this.inGround && this.dartShake <= 0) {
			par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(LeagueItems.dart, 1));
	...
	/**
	 * Sets the amount of knockback the dart applies when it hits a mob.
	 */
	...
	/**
	 * Whether the dart has a stream of critical hit particles flying behind it.
	 */
