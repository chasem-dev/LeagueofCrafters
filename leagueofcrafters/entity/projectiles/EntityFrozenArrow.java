...
import leagueofcrafters.entity.damagesources.EntityFrozenArrowDamageSource;
...
public class EntityFrozenArrow extends EntityThrowable implements IProjectile {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	private int inTile;
	...
	/** 1 if the player can pick up the FrozenArrow */
	public int canBePickedUp;

	/** Seems to be some sort of timer for animating an FrozenArrow. */
	public int FrozenArrowShake;

	/** The owner of this FrozenArrow. */
	public Entity shootingEntity;
	private int ticksInGround;
	private int ticksInAir;
	private double damage = 2.0D;

	/** The amount of knockback an FrozenArrow applies when it hits a mob. */
	private int knockbackStrength;

	public EntityFrozenArrow(World par1World) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public EntityFrozenArrow(World par1World, double par2, double par4, double par6) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityFrozenArrow(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityFrozenArrow(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLivingBase;
	...
	/**
	 * Similar to setFrozenArrowHeading, it's point the throwable entity to a x,
	 * y, z direction.
	 */
	...
	public void onUpdate() {
		...
		if (this.FrozenArrowShake > 0) {
			--this.FrozenArrowShake;
		}
			...
			if (movingobjectposition != null) {
				if (movingobjectposition.entityHit != null) {
					...
					if (this.shootingEntity == null) {
						damagesource = this.causeFrozenArrowDamage(this, this);
					} else {
						damagesource = this.causeFrozenArrowDamage(this, this.shootingEntity);
					}
	...
	public static DamageSource causeFrozenArrowDamage(EntityFrozenArrow par0EntityFrozenArrow, Entity par1Entity) {
		return (new EntityFrozenArrowDamageSource("FrozenArrow", par0EntityFrozenArrow, par1Entity)).setProjectile();
	}
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
		...
		par1NBTTagCompound.setByte("shake", (byte) this.FrozenArrowShake);
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
		...
		this.FrozenArrowShake = par1NBTTagCompound.getByte("shake") & 255;
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
		if (this.inGround && this.FrozenArrowShake <= 0) {
			par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(LeagueItems.frozenArrow, 1));
	...
	/**
	 * Sets the amount of knockback the FrozenArrow applies when it hits a mob.
	 */
	...
	/**
	 * Whether the FrozenArrow has a stream of critical hit particles flying
	 * behind it.
	 */
