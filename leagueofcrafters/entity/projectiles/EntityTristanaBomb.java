...
import leagueofcrafters.entity.damagesources.EntityBombDamageSource;
import leagueofcrafters.entity.damagesources.EntityTristanaBombDamageSource;
...
public class EntityTristanaBomb extends EntityThrowable implements IProjectile {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	private int inTile;
	...
	/** 1 if the player can pick up the Bomb */
	public int canBePickedUp;

	/** Seems to be some sort of timer for animating an Bomb. */
	public int BombShake;
	...
	public EntityTristanaBomb(World par1World) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public EntityTristanaBomb(World par1World, double par2, double par4, double par6) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityTristanaBomb(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityTristanaBomb(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLivingBase;
	...
	/**
	 * Similar to setBombHeading, it's point the throwable entity to a x, y, z
	 * direction.
	 */
	...
	public void onUpdate() {
		...
		if (this.inGround) {
			...
			if (movingobjectposition != null) {
				if (movingobjectposition.entityHit != null) {
					...
					if (this.shootingEntity == null) {
						damagesource = this.causeBombDamage(this, this);
					} else {
						damagesource = this.causeBombDamage(this, this.shootingEntity);
					}
			...
			// this.motionX * (double) l / 4.0D, this.posY + this.motionY *
			// (double) l / 4.0D, this.posZ
			// + this.motionZ * (double) l / 4.0D, -this.motionX, -this.motionY
			// + 0.2D, -this.motionZ);
			// }
	...
	public static DamageSource causeBombDamage(EntityTristanaBomb par0EntityBomb, Entity par1Entity) {
		return (new EntityTristanaBombDamageSource("TristanaBomb", par0EntityBomb, par1Entity)).setProjectile();
	}
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
		...
		par1NBTTagCompound.setByte("shake", (byte) this.BombShake);
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
		...
		this.BombShake = par1NBTTagCompound.getByte("shake") & 255;
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
		...
		this.worldObj.createExplosion(this, par1EntityPlayer.posX, par1EntityPlayer.posY + 0.3F, par1EntityPlayer.posZ, .4F, true);
		this.causeBombDamage(this, par1EntityPlayer);
		// par1EntityPlayer.attackEntityFrom(DamageSource.causeMobDamage(E),
		// (float)2F);
		this.setDead();
	}
	...
	/**
	 * Sets the amount of knockback the Bomb applies when it hits a mob.
	 */
	...
	/**
	 * Whether the Bomb has a stream of critical hit particles flying behind it.
	 */
