...
public class EntityTristanaBomb extends EntityThrowable implements IProjectile {
	...
	public static DamageSource causeBombDamage(EntityTristanaBomb par0EntityBomb, Entity par1Entity) {
		return (new EntityBombDamageSource("Bomb", par0EntityBomb, par1Entity)).setProjectile();
	}
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
		...
		//this.worldObj.createExplosion(this, par1EntityPlayer.posX, par1EntityPlayer.posY + .5F, par1EntityPlayer.posZ, 1F, true);
		//this.setDead();
	}
