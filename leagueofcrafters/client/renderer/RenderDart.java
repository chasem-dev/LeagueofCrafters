...
public class RenderDart extends Render {
	private static final ResourceLocation DartTextures = new ResourceLocation("league:textures/entity/dart.png");
	...
	public void renderDart(EntityDart par1EntityDart, double par2, double par4, double par6, float par8, float par9) {
		...
		float f11 = (float) par1EntityDart.dartShake - par9;
	...
	protected ResourceLocation getDartTextures(EntityDart par1EntityDart) {
		return DartTextures;
	}
	...
	protected ResourceLocation getEntityTexture(Entity par1Entity) {
		return this.getDartTextures((EntityDart) par1Entity);
	}
