...
public class TileEntityNexusRender extends TileEntitySpecialRenderer {
	private static final ResourceLocation field_110629_a = new ResourceLocation("textures/entity/beacon_beam.png");

	/**
	 * Render a Nexus tile entity.
	 */
	public void renderTileEntityNexusAt(TileEntityNexus par1TileEntityNexus, double par2, double par4, double par6, float par8) {
		float f1 = par1TileEntityNexus.func_82125_v_();
		...
		if (f1 > 0.0F) {
			...
			float f2 = (float) par1TileEntityNexus.getWorldObj().getTotalWorldTime() + par8;
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		this.renderTileEntityNexusAt((TileEntityNexus) par1TileEntity, par2, par4, par6, par8);
	}
}
