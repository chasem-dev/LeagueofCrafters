...
public class RenderEDragon extends RenderLiving {
	...
	private static final ResourceLocation enderDragonTextures = new ResourceLocation("league", "textures/models/mundo.png");

	/** An instance of the dragon model in RenderDragon */
	protected ModelDragon modelDragon;

	public RenderEDragon() {
	...
	public void renderDragon(EntityDragon par1EntityDragon, double par2, double par4, double par6, float par8, float par9) {
		...
		if (par1EntityDragon.healingEnderCrystal != null) {
			...
			f3 = (f3 * f3 + f3) * 0.2F;
			float f4 = (float) (par1EntityDragon.healingEnderCrystal.posX - par1EntityDragon.posX - (par1EntityDragon.prevPosX - par1EntityDragon.posX)
					* (double) (1.0F - par9));
			float f5 = (float) ((double) f3 + par1EntityDragon.healingEnderCrystal.posY - 1.0D - par1EntityDragon.posY - (par1EntityDragon.prevPosY - par1EntityDragon.posY)
					* (double) (1.0F - par9));
			float f6 = (float) (par1EntityDragon.healingEnderCrystal.posZ - par1EntityDragon.posZ - (par1EntityDragon.prevPosZ - par1EntityDragon.posZ)
					* (double) (1.0F - par9));
