...
public class ItemFreljordBow extends Item {
	public static final String[] frozenPullIconNameArray = new String[] { "0", "1", "2", "3" };
	@SideOnly(Side.CLIENT)
	private Icon[] iconArray;
	private Entity player;
	private int iconNum;

	public ItemFreljordBow(int par1) {
		super(par1);
		this.maxStackSize = 1;
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4) {
		...
		if (flag || par3EntityPlayer.inventory.hasItem(LeagueItems.bomb.itemID)) {
			...
			EntityFrozenArrow entityBomb = new EntityFrozenArrow(par2World, par3EntityPlayer, f * 1.0F);
			...
			if (!par2World.isRemote) {
				entityBomb.setPosition(par3EntityPlayer.posX, par3EntityPlayer.posY + 2, par3EntityPlayer.posZ);
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(LeagueItems.frozenArrow.itemID)) {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.itemIcon = par1IconRegister.registerIcon("league:" + "frozen_0");
		this.iconArray = new Icon[frozenPullIconNameArray.length];

		for (int i = 0; i < this.iconArray.length; ++i) {
			this.iconArray[i] = par1IconRegister.registerIcon("league:" + "frozen_" + frozenPullIconNameArray[i]);
		}
	}
	...
	@SideOnly(Side.CLIENT)
	/**
	 * used to cycle through icons based on their used duration, i.e. for the frozen
	 */
